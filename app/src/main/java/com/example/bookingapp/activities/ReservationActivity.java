...
////                .baseUrl("http://192.168.1.39:8080/api/") //http://10.0.2.2:8080/api/
...
//        Call<MessageResponse> call = ClientUtils.reservationService.createReservation(reservationRequest); //apiService.createReservation(reservationRequest);
...
public class ReservationActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            ...
            //ArrayList<DatePeriod> availability = intent. ("availability");
            int minGuests = intent.getIntExtra("minGuests", 0);
            int maxGuests = intent.getIntExtra("maxGuests", 0);
            String hostId = intent.getStringExtra("hostId");
            String accommodationId = intent.getStringExtra("accommodationId");
